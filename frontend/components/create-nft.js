...
const Create =()=>{
const {setFormData,CreateNft,formData,disability,fileWatcher,uploadMetaData} = useContext(TransactionContext)
                        ...
                        <form className="row" action="#">
                            ...
                            <div className="col-md-12 col-xl-8 mt_lg--15 mt_md--15 mt_sm--15">
                                <div className="input-box">
                                    <button className="btn btn-primary btn-large w-100" disabled={disability} type='button' onClick={uploadMetaData} >Submit Item</button>
                                </div>
                            </div>
