                ...
                <div   className="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-12">
                    <Link href="product-details.html" className="rn-collection-inner-one">
                        <div className="collection-wrapper">
                            ...
                            <div className="collenction-small-thumbnail">
                                <Image  src="/images/collection/collection-sm-04.jpg" alt="Nft_Profile" width={67} height={45}/>
                                <Image  src="/images/collection/collection-sm-05.jpg" alt="Nft_Profile" width={67} height={45} />
                                <Image  src="/images/collection/collection-sm-06.jpg" alt="Nft_Profile" width={67} height={45} />
                            </div>
                            <div className="collection-profile">
                                <Image  src="/images/client/client-12.png" alt="Nft_Profile" width={70} height={70} />
                            </div>
                            <div className="collection-deg">
                ...
                <div   className="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-12">
                    <Link href="product-details.html" className="rn-collection-inner-one">
                        <div className="collection-wrapper">
                            ...
                            <div className="collenction-small-thumbnail">
                                <Image  src="/images/collection/collection-sm-07.jpg" alt="Nft_Profile" width={67} height={45} />
                                <Image  src="/images/collection/collection-sm-08.jpg" alt="Nft_Profile" width={67} height={45} />
                                <Image  src="/images/collection/collection-sm-09.jpg" alt="Nft_Profile" width={67} height={45} />
                            </div>
                            <div className="collection-profile">
                                <Image  src="/images/client/client-13.png" alt="Nft_Profile" width={70} height={70} />
                            </div>
                            <div className="collection-deg">
                ...
                <div className="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-12">
                    <Link href="product-details.html" className="rn-collection-inner-one">
                        <div className="collection-wrapper">
                            ...
                            <div className="collenction-small-thumbnail">
                                <Image  src="/images/collection/collection-sm-10.jpg" alt="Nft_Profile" width={67} height={45} />
                                <Image  src="/images/collection/collection-sm-11.jpg" alt="Nft_Profile" width={67} height={45} />
                                <Image  src="/images/collection/collection-sm-12.jpg" alt="Nft_Profile" width={67} height={45} />
                            </div>
                            <div className="collection-profile">
                                <Image  src="/images/client/client-14.png" alt="Nft_Profile" width={70} height={70} />
                            </div>
                            <div className="collection-deg">
